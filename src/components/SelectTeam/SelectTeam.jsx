  ...
  return (
    <div className="flex items-center gap-12 self-start mt-32 font-thasadith border-b pb-16  border-dashed rounded-xl drop-shadow-lg animate-fadein">
      <div className="flex items-center gap-16">
        <h1 className="text-[96px] font-animal text-blush">Paulina</h1>
      ...
      <div className="flex flex-col gap-2 text-blush font-bold">
      ...
      <div className="flex items-center gap-16">
        ...
        <h1 className="text-[96px] font-animal text-blush border-foundation">Meghan</h1>
      </div>
